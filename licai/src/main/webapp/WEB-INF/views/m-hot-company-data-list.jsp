...
<script type="text/javascript" charset="utf-8">
    ...
    $('#hot-company-data-list').datagrid({
        ...
        columns: [[
            ...
            {field: 'hotType1', title: '热点1', width: 65, align: 'center'},
            {field: 'hotType2', title: '热点2', width: 65, align: 'center'},
            {field: 'hotType3', title: '热点3', width: 65, align: 'center'},
            {field: 'hotType4', title: '热点4', width: 65, align: 'center'},
            {field: 'hotType5', title: '热点5', width: 65, align: 'center'},
