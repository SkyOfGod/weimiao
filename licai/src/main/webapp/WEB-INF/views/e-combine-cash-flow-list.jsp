...
<script type="text/javascript">
    ...
    $('#cash-flow-list').datagrid({
        ...
        columns: [[
            ...
            {field: 'businessToProfit', title: '经营活动产生的现金流量净额', width: 150, align: 'right'},
            {field: 'investmentToProfit', title: '投资活动产生的现金流量净额', width: 150, align: 'right'},
            {field: 'financingToProfite', title: '筹资活动产生的现金流量净额', width: 150, align: 'right'},
            {field: 'saleToCash', title: '销售商品提供劳务收到的现金', width: 150, align: 'right'},
            {field: 'salary', title: '支付给职工以及为职工支付的现金', width: 150, align: 'right'},
            {field: 'investmentInsideOut', title: '购建固定资产、无形资产和其他长期资产支付的现金', width: 150, align: 'right'},
            {field: 'investmentInsideIn', title: '处置固定资产、无形资产和其他长期资产收回的现金净额', width: 150, align: 'right'},
            {field: 'investmentOutsideSubOut', title: '收购或投资子公司，对外扩大经营', width: 150, align: 'right'},
            {field: 'investmentOutsideMoneyOut', title: '投资支付的现金', width: 120, align: 'right'},
            {field: 'cashAndCashEquivalentsAdd', title: '现金及现金等价物净增加额', width: 150, align: 'right'},
            {field: 'cashAndCashEquivalentsBegin', title: '期初现金及现金等价物余额', width: 150, align: 'right'},
            {field: 'cashAndCashEquivalentsEnd', title: '期末现金及现金等价物余额', width: 150, align: 'right'},
