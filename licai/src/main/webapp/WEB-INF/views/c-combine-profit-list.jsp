...
<script type="text/javascript" charset="utf-8">
    ...
    $('#combine-profit-list').datagrid({
        ...
        columns: [[
            ...
            {field: 'businessIncome', title: '营业收入', width: 110, align: 'right'},
            {field: 'businessCosts', title: '营业成本', width: 110, align: 'right'},
            {field: 'taxRevenueTotal', title: '税金及附加', width: 100, align: 'right'},
            {field: 'sellingExpenses', title: '销售费用', width: 100, align: 'right'},
            {field: 'manageExpenses', title: '管理费用', width: 110, align: 'right'},
            {field: 'financialExpenses', title: '财务费用', width: 100, align: 'right'},
            {field: 'assetsImpairmentLoss', title: '资产减值损失', width: 100, align: 'right'},
            {field: 'incomeFromChangesInFairValue', title: '公允价值变动收益', width: 100, align: 'right'},
            {field: 'incomeFromInvestment', title: '投资收益', width: 100, align: 'right'},
            {field: 'businessProfit', title: '营业利润', width: 100, align: 'right'},
            {field: 'nonBusinessIncome', title: '营业外收入', width: 100, align: 'right'},
            {field: 'nonBusinessCosts', title: '营业外支出', width: 100, align: 'right'},
            {field: 'totalProfit', title: '利润总额', width: 100, align: 'right'},
            {field: 'incomeTaxExpense', title: '所得税费用', width: 100, align: 'right'},
            {field: 'netProfit', title: '净利润', width: 100, align: 'right'},
