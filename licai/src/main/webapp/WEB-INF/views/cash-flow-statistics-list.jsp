...
<script type="text/javascript">
    ...
    $('#cash-flow-statistics-list').datagrid({
        ...
        columns: [[
            ...
            {field: 'bonusCash', title: '分红金额', width: 120, align: 'right'},
            {field: 'profitSubstractBonus', title: '现金净增额 经营活动产生的现金流量净额-分红', width: 150, align: 'right'},
            {field: 'cashInIncoming', title: '销售商品提供劳务收到的现金/营业收入', width: 150, align: 'right'},
            {field: 'expandInProfitRate', title: '购建资产/经营活动产生的现金流量净额', width: 150, align: 'right'},
            {field: 'sellInExpandRate', title: '处置资产/购建资产', width: 110, align: 'right'},
