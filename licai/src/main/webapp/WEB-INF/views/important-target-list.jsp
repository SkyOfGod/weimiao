...
<script type="text/javascript">
    ...
    $('#important-target-list').datagrid({
        ...
        columns: [[
            ...
            {field: 'tp1', title: 'ROE', width: 60, align: 'center'},
            {field: 'tp2', title: '净利润现金比例', width: 100, align: 'center'},
            {field: 'tp3', title: '资产负债率', width: 60, align: 'center'},
            {field: 'tp4', title: '毛利率', width: 60, align: 'center'},
            {field: 'tp5', title: '营业利润率', width: 100, align: 'center'},
            {field: 'tp6', title: '营业收入增长率', width: 100, align: 'center'},
            {field: 'tp7', title: '固定资产比例', width: 100, align: 'center'},
            {field: 'tp8', title: '分红率', width: 60, align: 'center'},
            {field: 'ta1', title: '人均年薪', width: 80, align: 'center'},
