...
<script type="text/javascript">
    ...
    $('#important-target-list').datagrid({
        ...
        columns: [[
            ...
            {field: 't1', title: 'ROE', width: 60, align: 'center'},
            {field: 't2', title: '净利润现金比例', width: 100, align: 'center'},
            {field: 't3', title: '资产负债率', width: 60, align: 'center'},
            {field: 't4', title: '毛利率', width: 60, align: 'center'},
            {field: 't5', title: '营业利润率', width: 100, align: 'center'},
            {field: 't6', title: '营业收入增长率', width: 100, align: 'center'},
            {field: 't7', title: '固定资产比例', width: 100, align: 'center'},
            {field: 't8', title: '分红率', width: 60, align: 'center'},
            {field: 't9', title: '人均年薪', width: 100, align: 'center'},
